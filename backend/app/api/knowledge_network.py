...
def explore(market: str | None = Query(None, max_length=16), symbol: str | None = Query(None, max_length=32),
            ...
            category: Literal["identity", "classification", "ownership", "financial", "market", "disclosure", "business", "legal", "evidence"] | None = None,
    ...
    return _read(lambda: service.explore(db, market=market, symbol=symbol, company_id=company_id,
        ...
        include_candidates=include_candidates, include_evidence=include_evidence, per_category=per_category, category=category))
