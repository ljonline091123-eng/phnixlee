...
class ModelProviderCreate(BaseModel):
    ...
    provider_type: str = Field(pattern=r"^(MOCK|OPENAI_COMPAT|GEMINI_REST|DEEPSEEK)$")
    enabled: bool = True
...
class ModelProviderUpdate(BaseModel):
    ...
    provider_type: str | None = Field(default=None, pattern=r"^(MOCK|OPENAI_COMPAT|GEMINI_REST|DEEPSEEK)$")
...
class ModelRouteRuleCreate(BaseModel):
    ...
    fallback_chain_json: list[str] = Field(default_factory=list)
...
class ModelRouteRuleUpdate(BaseModel):
    ...
    fallback_chain_json: list[str] | None = None
