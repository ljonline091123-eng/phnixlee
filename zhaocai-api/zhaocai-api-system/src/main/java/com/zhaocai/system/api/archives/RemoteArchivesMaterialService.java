 ...
 */
@FeignClient(contextId = "remoteArchivesMaterialService", configuration = ResultDataFeignConfig.class, value = ServiceNameConstants.ARCHIVES_SERVICE)
public interface RemoteArchivesMaterialService {
