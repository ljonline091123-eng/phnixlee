 ...
 */
@FeignClient(contextId = "remoteArchivesLabourService", configuration = ResultDataFeignConfig.class, value = ServiceNameConstants.ARCHIVES_SERVICE)
public interface RemoteArchivesLabourService {
