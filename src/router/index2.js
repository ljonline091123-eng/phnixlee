...
export const constantRoutes = [
  ...
  // },
  {
    ...
    children: [
      ...
      },
      {
        ...
        name: 'addContract',
        meta: { title: '新增合同信息', activeMenu: '/procurement/sign-contract' }
      },{
        path: 'contract-detail',
        component: () => import('@/views/procurement/contract-detail.vue'),
        name: 'contractDetail',
        meta: { title: '合同信息详情', activeMenu: '/procurement/sign-contract' }
      }
    ]
  },
  ...
  },
  {
    ...
    children: [
      {
        path: 'evauate-bids-detail/:params',
        component: () => import('@/views/evaluate-expert/evauate-bids-detail.vue'),
        name: 'evauate-bids-detail',
        meta: { title: '评标任务详情', activeMenu: '/evaluate-expert/evaluate-bids'  }
      },
    ]
  },
  {
    ...
    children: [
      ...
      {
        path: 'rating-form/:params',
        component: () => import('@/views/template/rating-form.vue'),
        name: 'evauate-bids-detail',
        meta: { title: '评分模板表单', activeMenu: '/template/rating'  }
      },
