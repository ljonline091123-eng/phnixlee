...
export function listMaterialDetails(query) {
  return request({
    url: '/archives/deviceArchives/list',
    method: 'get',
    params: query
  })
}
...
export function getMaterialDetails(id) {
  return request({
    url: '/archives/deviceArchives/' + id,
    method: 'get'
  })
}
...
export function addMaterialDetails(data) {
  return request({
    url: '/archives/deviceArchives/add',
    method: 'post',
    data: data
  })
}
...
export function updateMaterialDetails(data) {
  return request({
    url: '/archives/deviceArchives/edit',
    method: 'post',
    data: data
  })
}
...
export function delMaterialDetails(id) {
  return request({
    url: '/archives/deviceArchives/delete/' + id,
    method: 'POST'
  })
}
