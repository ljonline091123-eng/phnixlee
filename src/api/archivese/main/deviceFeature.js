...
export function addDeviceItem(data) {
  return request({
    url: '/archives/deviceFeature/add',
    method: 'post',
    data: data
  })
}
...
export function editDeviceItem(data) {
  return request({
    url: '/archives/deviceFeature/edit',
    method: 'post',
    data: data
  })
}
...
export function delDeviceItem(id) {
  return request({
    url: '/archives/deviceFeature/delete/' + id,
    method: 'post'
  })
}
