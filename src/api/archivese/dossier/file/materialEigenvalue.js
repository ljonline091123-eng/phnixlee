...
export function materialEigenvalueInitData(query) {
  return request({
    url: '/archives/materialEigenvalue/initData',
    method: 'get',
    params: query
  })
}
...
export function materialEigenvalueAdd(query) {
  return request({
    url: '/archives/materialEigenvalue/add',
    method: 'post',
    data: query
  })
}
...
export function materialEigenvalueEdit(query) {
  return request({
    url: '/archives/materialEigenvalue/edit',
    method: 'post',
    data: query
  })
}
...
export function materialEigenvalueDelete(id) {
  return request({
    url: '/archives/materialEigenvalue/delete/' + id,
    method: 'post',
  })
}