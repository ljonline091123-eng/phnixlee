  ...
  <div class="left">
    ...
    >
        <span slot-scope="{ node, data }" class="custom-tree-node">
          ...
          <div class="hover-operations operation-view">
            ...
            <el-tooltip :content="data.state!='1' && data.state!='3'?'编辑当前节点':'查看当前节点'" placement="top"
                        effect="dark">
              <i
          ...
          <div v-show="isMain" class="hover-operations operation-view">
            <el-tooltip v-if="data.isMain!=='Y' && data.mainId==='0'" content="新增至主库" placement="top"
                        effect="dark">
              <i
            ...
            <el-tooltip v-if="data.isMain!=='Y' && data.mainId==='0'" content="关联至主库" placement="top"
                        effect="dark">
              <i
