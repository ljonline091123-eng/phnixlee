<template>
    <div class="container">
      ...
      <div style="width: 50%;border-left: solid 1px #E7E7E7;">
        ...
        <el-table  :data="eigenvalueList" stripe @row-click="clickRowMainTZZ" :highlight-current-row="true" style="width: 99%; margin-left: 1%;margin-top: 8px;">
      ...
      <div v-if="radioTypeM=='2M'"  style="width: 99%;">
        ...
        <el-table  :data="detailsList" stripe  @row-click="clickRowMain" :highlight-current-row="true" style="width: 99%;margin-top: 8px;">
          ...
          <el-table-column label="所属分类" align="center" prop="deviceClassName" show-overflow-tooltip/>
        ...
        <el-form ref="formDetail" :model="formDetail" :rules="rulesDetail" label-width="128px">
          ...
          <el-row>
            <el-form-item label="设备编号:" prop="deviceCode" >
              <el-input v-model="formDetail.deviceCode" placeholder="请输入" />
            </el-form-item>
          </el-row>
  
          <el-row>
              <el-form-item label="设备名称:" prop="deviceName">
                <el-input v-model="formDetail.deviceName" placeholder="请输入" />
              </el-form-item>
          </el-row>
          <el-row>
  ...
  <script>
    ...
    import {addDeviceItem,editDeviceItem,getDeviceItem,delDeviceItem } from "@/api/archivese/main/deviceFeature";
    import {materialEigenvalueInitData,getMaterialEigenvalueList,materialEigenvalueAdd,materialEigenvalueEdit,getEigenvalue,materialEigenvalueDelete } from "@/api/archivese/main/featureValue"
    import {materialInitData} from "@/api/archivese/dossier/materialType";
    import {addMaterialDetails , updateMaterialDetails,getMaterialDetails,delMaterialDetails } from "@/api/archivese/main/deviceArchives";
...
watch:{
  featureList: {
    ...
    getMaterialEigenvalueListFn(row){
      getMaterialEigenvalueList({deviceFeatureId:row.id}).then(response => {
      ...
      async  featureSubmitForm(){
        ...
        if (valid) {
          ...
          this.form.deviceClassId=this.currentNode.id
      ...
      async  detailSubmitForm(){
        ...
        if (valid) {
          ...
          this.formDetail.deviceClassId=this.currentNode.id
          this.formDetail.deviceClassName=this.currentNode.label
          console.log(JSON.stringify(this.currentNode))
      ...
      async  eigenSubmitForm(){
        ...
        if (valid) {
          ...
          this.formZ.deviceClassId=this.currentNode.id
          this.formZ.deviceFeatureId=this.currentFeature.id
