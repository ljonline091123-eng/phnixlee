...
import {
  ...
  getLoadTaskDef, getLoadTaskDefExpert,
  getProcessLogList, getProcessLogListExpert, getOrgByUserId,
...
export default {
  ...
  created() {
    if(this.$route.query.id){
      ...
      const eid = JSON.parse(Base64.decode(this.$route.params.params));
      this.id=eid
      this.getInfoDetail(eid)
      this.type='check'
      this.isSubmit = true;
    }
  },
