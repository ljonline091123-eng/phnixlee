<template>
    ...
    <el-table v-loading="loading" :data="myProcessList"  highlight-current-row
                  height="100%"
                  class="flex1"
                  stripe
    ...
    <el-dialog :title="title" :visible.sync="open" width="80%" append-to-body>
      <el-form :model="queryProcessParams" ref="queryProcessForm" :inline="true" v-show="showSearch" label-width="68px">
        ...
        <el-form-item>
          <el-button type="primary" icon="el-icon-search" size="small" @click="handleProcessQuery">{{ $t('common.search') }}</el-button>
          <el-button icon="el-icon-refresh" size="small" @click="resetProcessQuery">{{ $t('common.reset') }}</el-button>
        </el-form-item>
      </el-form>
