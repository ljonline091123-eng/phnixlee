...
import com.zhaocai.flowable.service.ISysFormService;
import com.zhaocai.flowable.domain.SysForm;
import com.zhaocai.flowable.mapper.SysFormMapper;
import com.zhaocai.system.api.RemoteFileService;
    ...
    public SysForm selectSysFormByProcInsId(FlowTaskVo flowTaskVo) {
        ...
        if (processInstance != null) {
            ...
            if (flowElement instanceof UserTask) {
                String formReadOnly = flowElement.getAttributeValue(ProcessConstants.NAMASPASE, "formReadOnly");
                //值为空或者为N均表示false
                ...
                String formFieldReadOnly = flowElement.getAttributeValue(ProcessConstants.NAMASPASE, "formFieldReadOnly");
