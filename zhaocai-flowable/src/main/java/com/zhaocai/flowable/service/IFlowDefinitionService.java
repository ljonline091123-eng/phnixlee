...
public interface IFlowDefinitionService {
     ...
     */
    Map<String, Object> startProcessInstanceById1(String procDefId, Map<String, Object> variables);
     ...
     * @param variables 流程变量，表单参数
     */
    Map<String, Object> startProcessInstanceById2(String procDefId, Map<String, Object> variables);
     ...
     * @return
     */
    String getByProcDefKey(String procDefKey);
}
