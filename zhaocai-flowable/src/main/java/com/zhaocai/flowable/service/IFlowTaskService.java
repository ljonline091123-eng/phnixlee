...
import com.zhaocai.flowable.domain.dto.FlowNextDto;
...
public interface IFlowTaskService {
     ...
     * @return 代办任务列表
     */
    Map<String, Object> todoListV2(Integer pageNum, Integer pageSize,FlowTaskDto flowtaskdto);
     ...
     * @param flowTaskDto 参数
     */
    Map<String, Object> finishedListV2(Integer pageNum, Integer pageSize,FlowTaskDto flowTaskDto);
