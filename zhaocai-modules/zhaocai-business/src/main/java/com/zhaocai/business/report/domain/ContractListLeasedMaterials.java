...
/**
 * 合同-租赁材料合同清单 contract_list_leased_materials
 *
 * @author lsn
 * @date 2024-10-13
 */
@Data
@TableName(value = "contract_list_leased_materials")
public class ContractListLeasedMaterials {
  ...
  @ApiModelProperty(value = "已进场工程量：回写")
