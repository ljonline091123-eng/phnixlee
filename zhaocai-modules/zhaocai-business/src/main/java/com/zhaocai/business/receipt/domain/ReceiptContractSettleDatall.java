...
/**
 * 结算单计日工对象 tb_receipt_contract_settle_datall
 *
 * @author CFF
 * @date 2024-09-07
 */
@Data
@TableName(value = "tb_receipt_contract_settle_datall")
@ApiModel(value = "ReceiptContractSettleDatall对象", description = "结算单计日工列表对象")
public class ReceiptContractSettleDatall extends BaseEntity {
    ...
    private BigDecimal currentTotalSettleQuantity;
    ...
    /**
     * 结算明细表关联id(合同计日工明细表id)
     */
    @ApiModelProperty("结算明细表关联id(合同计日工明细表id)")
    private String datallerId;

    /**
     * 明细表唯一id
     */
    @ApiModelProperty("明细表唯一id")
    private String datallerUniqueId;
    ...
    private BigDecimal preTotalSettleQuantity;
     ...
     * 工种名称（1-架子工 2 -钢筋工）
     */
    @ApiModelProperty("工种名称（1-架子工 2 -钢筋工）")
    ...
    public String toString() {
        return new ToStringBuilder(this, ToStringStyle.MULTI_LINE_STYLE)
                ...
                .append("datallerId", getDatallerId())
                .append("datallerUniqueId", getDatallerUniqueId())
