...
/**
 * 合同-购买材料合同清单 contract_list_materials
 *
 * @author lsn
 * @date 2024-10-13
 */
@Data
@TableName(value = "contract_list_materials")
public class ContractListMaterials {
  ...
  @ApiModelProperty(value = "价款类型(1-固定价 2-浮动价)")
  ...
  @ApiModelProperty(value = "已下订单数量（工程量）：采购订单回写")
