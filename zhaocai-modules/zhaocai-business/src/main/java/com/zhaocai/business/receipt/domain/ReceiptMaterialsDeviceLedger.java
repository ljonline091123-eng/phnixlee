...
/**
 * 设备租赁台账单据对象 tb_receipt_materials_device_ledger
 *
 * @author cff
 * @date 2024-09-10
 */
@Data
@TableName(value = "tb_receipt_materials_device_ledger")
@ApiModel(value = "ReceiptMaterialsDeviceLedger对象", description = "设备租赁台账单据对象")
public class ReceiptMaterialsDeviceLedger extends BaseEntity {
