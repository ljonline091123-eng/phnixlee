...
/**
 * 零星包工结算明细对象 tb_receipt_contract_settle_sporadic_work
 *
 * @author WH
 * @date 2024-09-07
 */
@Data
@TableName(value = "tb_receipt_contract_settle_sporadic_work")
@ApiModel(value = "ReceiptContractSettleSporadicWork对象", description = "零星包工结算明细对象")
public class ReceiptContractSettleSporadicWork extends BaseEntity {
