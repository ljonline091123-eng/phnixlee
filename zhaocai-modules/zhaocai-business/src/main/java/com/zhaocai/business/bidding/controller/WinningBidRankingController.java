...
public class WinningBidRankingController extends BaseController
{
     ...
     * 新增中标排行榜
     */
    @Log(title = "中标排行榜", businessType = BusinessType.INSERT)
    @PostMapping
    public AjaxResult add(@RequestBody WinningBidRanking winningBidRanking)
    {
        return toAjax(winningBidRankingService.insertWinningBidRanking(winningBidRanking));
    }

    /**
     * 修改中标排行榜
     */
    @Log(title = "中标排行榜", businessType = BusinessType.UPDATE)
    @PutMapping
    public AjaxResult edit(@RequestBody WinningBidRanking winningBidRanking)
    {
        return toAjax(winningBidRankingService.updateWinningBidRanking(winningBidRanking));
    }

    /**
     * 删除中标排行榜
     */
    @Log(title = "中标排行榜", businessType = BusinessType.DELETE)
	@DeleteMapping("/{ids}")
    public AjaxResult remove(@PathVariable Long[] ids)
    {
        return toAjax(winningBidRankingService.deleteWinningBidRankingByIds(ids));
    }
}
