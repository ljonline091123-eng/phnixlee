...
public interface IProcurementPlanService  extends IService<ProcurementPlan>, IProcessBusinessBaseService, IPBMOverrideService {
    ...
    /** 由集成事件处理器调用，不依赖当前 HTTP 登录上下文。 */
    void deliverProcurementPlanPush(ContractPlanningPushPayload payload);
    ...
    List<MaterialsVO> importDataTwo(List<MaterialsListImportDTO> userList, String radioType, String operName);
}
