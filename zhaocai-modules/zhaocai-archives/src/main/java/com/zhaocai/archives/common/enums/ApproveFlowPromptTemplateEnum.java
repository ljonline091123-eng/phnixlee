...
public enum ApproveFlowPromptTemplateEnum {
    ...
    DOSSIER_MATERIAL_PUSH("dossier_material_push", "您有材料档案：%s在审核节点的审批"),
    DOSSIER_DEVICE_PUSH("dossier_device_push", "您有设备档案：%s在审核节点的审批"),
    DOSSIER_LABOUR_PUSH("dossier_labour_push", "您有劳务档案：%s在审核节点的审批"),
    DOSSIER_SUB_PUSH("dossier_sub_push", "您有专业分包档案：%s在审核节点的审批"),
