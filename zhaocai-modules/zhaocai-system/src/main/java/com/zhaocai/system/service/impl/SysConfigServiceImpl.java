...
import com.zhaocai.system.domain.SysConfig;
import com.zhaocai.system.mapper.SysConfigMapper;
...
public class SysConfigServiceImpl implements ISysConfigService
{
    ...
    @Override
    public void setConfigValueByKey(String configKey, String configValue) {
        SysConfig sysConfig = configMapper.selectByConfigKey(configKey);
        if (sysConfig == null) {
            throw new RuntimeException(configKey + "对应的配置参数不存在");
        }
        redisService.deleteObject(getCacheKey(configKey));
        configMapper.updateConfigValueByKey(configKey,configValue);
    }
