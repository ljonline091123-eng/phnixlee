package com.zhaocai.system.service;
...
public interface ISysUserService extends IService<SysUser>
{
    ...
    boolean checkUserNameAndUserTypeUnique(SysUser user);
    ...
    SysUser getByThridUserId(String thridUserId);
    List<SysUser> getListByThridUserId(List<String> thridUserIds);

    String sendSmsCode(String phoneNumber);

    void checkCode(String phoneNumber, String smsCode, String uuid);
