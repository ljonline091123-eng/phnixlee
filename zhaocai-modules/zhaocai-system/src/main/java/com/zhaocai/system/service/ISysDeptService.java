...
public interface ISysDeptService extends IService<SysDept>
{
     ...
     * @return
     */
    SysDept getByThridDeptId(String thridDeptId);
    List<SysDept> getListByThridDeptId(List<String> thridDeptIds);
     ...
     * @return
     */
    List<SysDept> getBySwitchListThridDeptId(String thridDeptId);

    SysDept findSecondDept(String thridDeptId);
