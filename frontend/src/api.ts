...
export type LakeObject = { id: string; object_uri: string; layer: string; bucket?: string; object_key?: string; content_hash: string; content_type: string; byte_size: number; source_table?: string; source_code?: string; object_type?: string; domain?: string; source_record_id?: string; dataset_version?: string; created_at: string };
export type LakeDocumentChunk = { id: string; document_key: string; document_id?: string; chunk_index: number; chunk_version: string; content_hash: string; text_preview: string; start_offset: number; end_offset: number; parser_version: string; embedding_model?: string; embedding_status?: string; embedding_dimensions?: number; status: string; section_title?: string; boundary_type?: string; chunk_method?: string; created_at: string };
