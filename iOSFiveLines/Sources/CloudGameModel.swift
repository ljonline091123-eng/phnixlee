...
final class CloudGameModel: ObservableObject {
    ...
    private static func dailyLayout(_ index: Int) -> [Tile?] {
        ...
        if index == 0 {
            let values: [Tile?] = [
                nil,.red,.pink,nil,nil,.pink,.red,nil,nil,
                .pink,.red,.red,.pink,.pink,.red,.red,.pink,nil,
                .red,.pink,.red,.pink,.red,.pink,.red,.pink,nil,
                nil,.red,.red,.red,.red,nil,nil,nil,nil,
                nil,nil,.pink,.red,.red,.pink,nil,.red,nil,
                nil,nil,nil,.red,.pink,nil,nil,nil,nil,
